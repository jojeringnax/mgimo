                    ...
                    @foreach($subscribers as $subscriber)
                        <tr class="text-center">
                            ...
                            <td width="10%" class="action">
                                {{ link_to_action('AdminController@updateSubscriber', '', ['id' => $subscriber->id], ['class' => 'oi oi-pencil']) }}
                                {{ link_to_action('AdminController@deleteSubscriber', '', ['id' => $subscriber->id], ['class' => 'oi oi-delete delete-admin']) }}
                            </td>
                        </tr>
                    @endforeach
                    </tbody>
