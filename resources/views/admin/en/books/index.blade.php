                    ...
                    @foreach($books as $element)
                        <tr>
                            ...
                            <td width="10%" class="text-center action">
                                {{ link_to_action('en\AdminController@updateBook', '', ['id' => $element->id], ['class' => 'oi oi-pencil']) }}
                                {{ link_to_action('en\AdminController@deleteBook', '', ['id' => $element->id], ['class' => 'oi oi-delete delete-admin']) }}
                            </td>
                        </tr>
                    @endforeach
                    </tbody>
                </table>
                {{ link_to_action('en\AdminController@createBook', 'create',[], ['class' => 'btn btn-secondary']) }}
            </div>
        </div>
    </div>
@endsection
