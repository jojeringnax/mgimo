    ...
    <div class="container">
        <div class="row d-flex justify-content-center">
            <div class="col-8 d-flex flex-column" style="height:100%">
                {{ !isset($congratulation) ? Form::open(array('action' => 'en\AdminController@createCongratulation', 'files' => true)) : Form::model($congratulation, ['files' => true]) }}
...
@endsection
@section('script')
    <script src="{{asset('en/congratulation_form.js')}}"></script>
    <script>
