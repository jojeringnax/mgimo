    ...
    <div class="container">
        <div class="row">
            <div class="admin admin-smis" style="width:100%">
                    ...
                    @foreach($partnersCompany as $element)
                        <tr class="text-center">
                            ...
                            <td width="10%" class="action">
                                {{ link_to_action('en\AdminController@updatePartner', '', ['id' => $element->id], ['class' => 'oi oi-pencil']) }}
                                {{ link_to_action('en\AdminController@deletePartner', '', ['id' => $element->id], ['class' => 'oi oi-delete delete-admin']) }}
                            </td>
                        </tr>
                    @endforeach
                    </tbody>
                ...
                {{ link_to_action('en\AdminController@createPartner', 'create',[], ['class' => 'btn btn-secondary']) }}
            </div>
        </div>
    </div>
@endsection