                    ...
                    @foreach($news as $element)
                        <tr class="text-center">
                            ...
                            <td width="10%" class="action">
                                {{ link_to_action('en\AdminController@updateArticle', '', ['id' => $element->id], ['class' => 'oi oi-pencil']) }}
                                {{ link_to_action('en\AdminController@deleteArticle', '', ['id' => $element->id], ['class' => 'oi oi-delete delete-admin']) }}
                            </td>
                        </tr>
                    @endforeach
                    </tbody>
                </table>
                {{ link_to_action('en\AdminController@createArticle', 'create',[], ['class' => 'btn btn-secondary']) }}
            </div>
        </div>
    </div>
