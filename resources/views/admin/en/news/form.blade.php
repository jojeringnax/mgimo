...
@section('content')
    ...
    <div class="container">
        <div class="row d-flex justify-content-center">
            <div class="col-9">
                {{ !isset($article) ? Form::open(array('action' => 'en\AdminController@createArticle', 'files' => true, 'class'=>'news-form')) : Form::model($article, ['files' => true, 'class'=>'news-form']) }}
                        ...
                        <div style="display: flex;align-items: center; justify-content: space-around;">
                            @foreach($photos as $photo)
                                <div style="position: relative; width: 500px; height: 375px;">
                                    ...
                                    <a href="{{ action('en\PhotoController@delete', ['id' => $photo->id, 'from' => 'news']) }}" style="width: 50px; height: 50px; position: absolute;right:10px;top:10px;font-size: 50px;color: white;">X</a>
                                </div>
                            @endforeach
                        </div>
                    @endif
