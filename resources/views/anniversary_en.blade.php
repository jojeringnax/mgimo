                ...
                <div id="photos-news " class="col-xl-5 col-lg-5 col-md-6 col-sm-12 col-12 d-flex flex-column justify-content-start">
                    <div class="anniversary-img">
                        <div class="item-img-news" style="text-align: center;">
                            <img src="{{asset('img/icon/logo.svg')}}" alt="" style="width: 40%">
                            <div class="hide-text">
                                <p class="text-left">
                        ...
                        <div class="item-img-news">
                            <img src="{{asset('img/anniversary/1.jpg')}}" alt="images_anniversary_1" style="width: 100%">
                            <div class="hide-text">
                                <ul class="text-left">
                                    <li>
                        ...
                        <div class="item-img-news">
                            <img src="{{asset('img/anniversary/2.jpg')}}" alt="" style="width: 100%">
                            <div class="hide-text">
                                <p>
                        ...
                        <div class="item-img-news">
                            <img src="{{asset('img/anniversary/3.jpg')}}" alt="" style="width: 100%">
                            <div class="hide-text">
                                <p>
                        ...
                        <div class="item-img-news">
                            <img src="{{asset('img/anniversary/4.jpg')}}" alt="" style="width: 100%">
                            <div class="hide-text">
                                <p>
                        ...
                        <div class="item-img-news">
                            <img src="{{asset('img/anniversary/5.jpg')}}" alt="" style="width: 100%">
                            <div class="hide-text">
